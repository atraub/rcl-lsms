 ...
 * Login
 *
 * Prompts user to login in order to use the system
 *
 * @package		LSMS
 * @author		Nackil Sung, Erin Kim
 * @since		Version 1.0.2
...
$error_msg = "";
if(!isset($_SESSION['destination_page'])) {
  $destination_page = $SYSTEM_BASE_URL;
}
else {
  $destination_page = $_SESSION['destination_page'];
}

if(isset($_POST['username'])) {
  if(($_POST['username'] == $LSMS_USERNAME) && ($_POST['password'] == $LSMS_PASSWORD)) {
    $_SESSION['authd'] = TRUE;
...
<div id="login-h1">Library Stacks Management System<br />Please log in</div>
<div id="errormsg"><?php echo $error_msg; ?></div>
  <fieldset id="inputs">
